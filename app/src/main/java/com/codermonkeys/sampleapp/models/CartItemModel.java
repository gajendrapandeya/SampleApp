...
public class CartItemModel {
    ...
    public CartItemModel(int type, int productImage, int freeCoupens, int productQuantity, String productTitle, String productPrice, String cuttedPrice, int offersApplied, int coupensApplied) {
        this.type = type;
