...
import com.codermonkeys.sampleapp.ViewAllActivity;
...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public static class StripAdViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setStripAd(String resource, String color) {
            Glide.with(itemView.getContext()).load(resource).apply(new RequestOptions().placeholder(R.drawable.strip)).into(stripAdImage);
    ...
    public class HorizontalProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public HorizontalProductViewHolder(@NonNull View itemView) {
            ...
            horizontalLayoutViewAllButton = itemView.findViewById(R.id.horizontal_scroll_layout_button);
    ...
    public static class GridProductViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setGridProductLayout(List<HorizontalProductScrollModel> horizontalProductScrollModelList, String title) {
            ...
            for(int x = 0; x < 4; x++) {
                ...
                TextView productDescription = gridProductLayout.getChildAt(x).findViewById(R.id.h_s_prodcut_description);
